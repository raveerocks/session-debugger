...
import { getSeleniumLogsSummary } from '../../controllers/SeleniumLogsController';
import moment from 'moment';

const SeleniumSummary = (props) => {
  const [result, setResult] = useState();

  useEffect(() => {
    getSeleniumLogsSummary(props.category, props.session)
      .then((response) => {
            ...
            <Row>
              <Column>
                <VTableCard>
                  ...
                  <VRowCard>
                    <VHColumnCard>Polls</VHColumnCard>
                    <VColumnCard>{result.polls}</VColumnCard>
                  </VRowCard>
                  <VRowCard>
...
export default SeleniumSummary;
